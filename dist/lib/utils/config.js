...
class Config {
    constructor() {
        ...
        this.landingPageMdSrc = 'https://github-cdn.now.sh/privatenumber/github-cdn/master/readme.md?token';
    ...
    canAccess({ owner, repo, gists }) {
        ...
        return this.whitelist.some((whitelistItem) => (whitelistItem.owner.test(owner)
